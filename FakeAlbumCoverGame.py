...
print (raw_random_wikipedia_page)
...
#page = requests.post(wikipedia_link, data=raw_random_wikipedia_page).text
...
#Question 3
band_title = ''.join(titles).replace(' - Wikipedia','')
print(band_title)
...
doc = lxml.html.fromstring(requests.get(wikipedia_link).text)
titles = doc.xpath('.//title/text()')
print (titles)
album_title = ''.join(titles).replace(' - Wikipedia','')
print(album_title)
